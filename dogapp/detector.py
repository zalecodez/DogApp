...
namefilename = os.path.join(os.getcwd(),"dogapp/dognames.txt")
...
face_cascade = cv2.CascadeClassifier('dogapp/haarcascades/haarcascade_frontalface_alt.xml')
...
bottleneck_features = np.load('dogapp/bottleneck_features/DogVGG19Data.npz')
...
vgg19model.load_weights('dogapp/saved_models/weights.best.VGG19.hdf5')
